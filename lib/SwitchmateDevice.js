...
var SwitchmateDevice = function(sm_peripheral) {
    ...
    sm_peripheral.discoverServices(['180f'], function(error, services) {
      var deviceBatteryService = services[0];
      console.log('discovered device battery service');

      deviceBatteryService.discoverCharacteristics(['2a19'], function(error, characteristics) {
...
NobleDevice.Util.mixin(SwitchmateDevice, NobleDevice.BatteryService);
